#!/bin/bash
# F9 strong-scaling experiment for bwUniCluster Ice Lake nodes.
...
data = {
    ...
    "experiment": "F9_parallel_strong_scaling",
...
echo "=== F9 strong-scaling run ${RUN_ID}, ${PROCS} MPI ranks, tau=${TAU} ==="
...
echo "=== F9 finished: ${EXPERIMENT_DIR} (${RANK_TAG}) ==="
